...
async function main() {
	...
	// initialize the new pool with USDC and cNOTE
	let initPoolCmd = abi.encode(
		["uint8", "address", "address", "uint256", "uint128"],
		[71, usdcAddress, cNoteAddress, 36001, 1]
	);
