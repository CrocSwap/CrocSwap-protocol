...
contract MarketSequencer is TradeMatcher {
     ...
     *             settings, and parameters for rolling gap-filled quantities if they
     ...
     * @param pool The pre-loaded specification and hash of the pool to be swapped against.
     * @return flow The net token flows generated by the swap. */
    function swapOverPool(
        ...
        sweepSwapLiq(
            flow,
            curve,
            curve.priceRoot_.getTickAtSqrtRatio(),
            dir,
            pool
        );
    ...
    function harvestOverPool(
        ...
        (baseFlow, quoteFlow) = harvestRange(
            curve,
            curve.priceRoot_.getTickAtSqrtRatio(),
            bidTick,
            askTick,
    ...
    function applyConcentrated(
        ...
        if (bend.isTickRel_) {
            ...
            require(
                (bend.lowTick_ >= TickMath.MIN_TICK) &&
